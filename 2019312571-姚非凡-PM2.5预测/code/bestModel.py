...
dataset = dataset.drop(columns=["hour","AQI","PM10",'grade','CO','NO2','O3','SO2'])
order = ['PM2.5']
...
print(theMean)
plt.savefig('/Users/yaofeifan/Documents/Tsinghua/Lesson/模式识别/Project2/bare_jrnl_transmag/Bestcm.pdf',bbox_inches = 'tight')
plt.show()
